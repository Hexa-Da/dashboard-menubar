...
| 🔑 | `gws_auth_status` = `auth_error` (et online) | Reconnecter Google : `gws auth login`. Notif macOS (son) sur passage en erreur, puis rappel toutes les 30 min tant que l'erreur persiste (`gws-auth-<epoch>`, ancre monotonic) |
